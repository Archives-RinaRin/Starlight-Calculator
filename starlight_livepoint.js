...
document.getElementById("calc_result").innerHTML = "최대치 : "+maxPoint+", 소모 수치 : "+totalPoints+" ("+pointsPerSong+" x "+numOfSongs+"곡)<br />획득 이벤트 재화 : "+totalEventCommodities+"개<br />기준 시간 : "+curTimeFormat+"<br />예상 시간 : "+estimatedTimeFormat+" 전후 ("+elapsedHours+"시간 "+elapsedMins+"분 전후)";
